...
import { CheckCircle2, Zap, Shield, Globe, Cpu, Sparkles, Star, StarHalf, Megaphone } from "lucide-react"
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link href="/request">
                  <Button size="lg" className="h-14 px-8 text-lg rounded-full font-bold shadow-xl hover:scale-105 transition-transform">
                    Request Website
                  </Button>
                </Link>
                <Link href="/types">
                  <Button size="lg" variant="outline" className="h-14 px-8 text-lg rounded-full glass font-bold shadow-xl hover:scale-105 transition-transform">
                    View Website Types
                  </Button>
                </Link>
              </div>
        ...
        {/* Testimonials */}
        <section id="testimonials-section" className="py-24 overflow-hidden relative">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16 space-y-4">
              ...
              {displayReviews.map((t, i) => (
                ...
                >
                  <div className="flex gap-1 mb-6">
                    {Array.from({ length: Math.floor(t.rating) }).map((_, star) => (
